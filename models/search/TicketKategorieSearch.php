...
/**
 * TicketKategorieSearch represents the model behind the search form of `app\models\TicketKategorie`.
 */
class TicketKategorieSearch extends TicketKategorie
{
